...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.textParam'
        db.add_column('explorer_item', 'textParam', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.textParam'
        db.delete_column('explorer_item', 'textParam')
