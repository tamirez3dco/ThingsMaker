...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GhDefinition.accepts_text_params'
        db.add_column('explorer_ghdefinition', 'accepts_text_params', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GhDefinition.accepts_text_params'
        db.delete_column('explorer_ghdefinition', 'accepts_text_params')
