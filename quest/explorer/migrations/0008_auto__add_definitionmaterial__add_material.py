...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DefinitionMaterial'
        db.create_table('explorer_definitionmaterial', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('definition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorer.GhDefinition'])),
            ('material', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorer.Material'])),
        ))
        db.send_create_signal('explorer', ['DefinitionMaterial'])

        # Adding model 'Material'
        db.create_table('explorer_material', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('readable_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('explorer', ['Material'])


    def backwards(self, orm):
        
        # Deleting model 'DefinitionMaterial'
        db.delete_table('explorer_definitionmaterial')

        # Deleting model 'Material'
        db.delete_table('explorer_material')
