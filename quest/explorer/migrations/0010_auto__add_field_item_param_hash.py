...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.param_hash'
        db.add_column('explorer_item', 'param_hash', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.param_hash'
        db.delete_column('explorer_item', 'param_hash')
