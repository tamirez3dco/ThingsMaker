...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.active'
        db.add_column('explorer_definitionparam', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.active'
        db.delete_column('explorer_definitionparam', 'active')
    ...
    models = {
        ...
        'explorer.item': {
            ...
            'param_hash': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
