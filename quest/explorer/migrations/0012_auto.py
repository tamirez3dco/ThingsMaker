...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Item', fields ['param_hash']
        db.create_index('explorer_item', ['param_hash'])


    def backwards(self, orm):
        
        # Removing index on 'Item', fields ['param_hash']
        db.delete_index('explorer_item', ['param_hash'])
