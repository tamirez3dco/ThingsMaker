...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('explorer_item', 'status', self.gf('django.db.models.fields.CharField')(default='CR', max_length=2), keep_default=False)

        # Adding field 'Item.num_trials'
        db.add_column('explorer_item', 'num_trials', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.status'
        db.delete_column('explorer_item', 'status')

        # Deleting field 'Item.num_trials'
        db.delete_column('explorer_item', 'num_trials')
