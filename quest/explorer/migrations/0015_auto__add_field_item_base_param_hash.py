...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.base_param_hash'
        db.add_column('explorer_item', 'base_param_hash', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.base_param_hash'
        db.delete_column('explorer_item', 'base_param_hash')
