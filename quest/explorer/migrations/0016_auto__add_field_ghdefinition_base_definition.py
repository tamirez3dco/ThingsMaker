...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GhDefinition.base_definition'
        db.add_column('explorer_ghdefinition', 'base_definition', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['explorer.GhDefinition'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GhDefinition.base_definition'
        db.delete_column('explorer_ghdefinition', 'base_definition_id')
    ...
    models = {
        ...
        'explorer.ghdefinition': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'base_definition': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['explorer.GhDefinition']", 'null': 'True'}),
