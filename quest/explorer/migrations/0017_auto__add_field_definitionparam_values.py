...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.values'
        db.add_column('explorer_definitionparam', 'values', self.gf('explorer.models.PickledObjectField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.values'
        db.delete_column('explorer_definitionparam', 'values')
    ...
    models = {
        ...
        'explorer.definitionparam': {
            ...
            'values': ('explorer.models.PickledObjectField', [], {'null': 'True'})
        },
