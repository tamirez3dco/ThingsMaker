...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.range_start'
        db.add_column('explorer_definitionparam', 'range_start', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'DefinitionParam.range_end'
        db.add_column('explorer_definitionparam', 'range_end', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.range_start'
        db.delete_column('explorer_definitionparam', 'range_start')

        # Deleting field 'DefinitionParam.range_end'
        db.delete_column('explorer_definitionparam', 'range_end')
