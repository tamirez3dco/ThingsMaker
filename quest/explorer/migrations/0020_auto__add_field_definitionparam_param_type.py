...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.param_type'
        db.add_column('explorer_definitionparam', 'param_type', self.gf('django.db.models.fields.CharField')(default='FL', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.param_type'
        db.delete_column('explorer_definitionparam', 'param_type')
