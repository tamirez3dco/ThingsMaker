...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GhDefinition.param_names'
        db.delete_column('explorer_ghdefinition', 'param_names')


    def backwards(self, orm):
        
        # Adding field 'GhDefinition.param_names'
        db.add_column('explorer_ghdefinition', 'param_names', self.gf('explorer.models.PickledObjectField')(null=True), keep_default=False)
