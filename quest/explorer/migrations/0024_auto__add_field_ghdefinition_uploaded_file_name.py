...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GhDefinition.uploaded_file_name'
        db.add_column('explorer_ghdefinition', 'uploaded_file_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GhDefinition.uploaded_file_name'
        db.delete_column('explorer_ghdefinition', 'uploaded_file_name')
