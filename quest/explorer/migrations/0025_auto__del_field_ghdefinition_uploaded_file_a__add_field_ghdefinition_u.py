...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GhDefinition.uploaded_file_a'
        db.delete_column('explorer_ghdefinition', 'uploaded_file_a')

        # Adding field 'GhDefinition.uploaded_file'
        db.add_column('explorer_ghdefinition', 'uploaded_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'GhDefinition.uploaded_file_a'
        db.add_column('explorer_ghdefinition', 'uploaded_file_a', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)

        # Deleting field 'GhDefinition.uploaded_file'
        db.delete_column('explorer_ghdefinition', 'uploaded_file')
