...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.rendering_view'
        db.add_column('explorer_definitionparam', 'rendering_view', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.rendering_view'
        db.delete_column('explorer_definitionparam', 'rendering_view')
