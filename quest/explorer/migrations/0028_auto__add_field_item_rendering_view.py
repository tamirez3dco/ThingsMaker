...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.rendering_view'
        db.add_column('explorer_item', 'rendering_view', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.rendering_view'
        db.delete_column('explorer_item', 'rendering_view')
