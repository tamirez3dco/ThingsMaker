...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GhDefinition.default_material'
        db.alter_column('explorer_ghdefinition', 'default_material_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorer.Material'], null=True))

        # Adding field 'Item.has_3dm'
        db.add_column('explorer_item', 'has_3dm', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GhDefinition.default_material'
        raise RuntimeError("Cannot reverse this migration. 'GhDefinition.default_material' and its values cannot be restored.")

        # Deleting field 'Item.has_3dm'
        db.delete_column('explorer_item', 'has_3dm')
    ...
    models = {
        ...
        'explorer.definitionparam': {
            ...
            'rendering_view': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'explorer.ghdefinition': {
            ...
            'default_material': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.Material']", 'null': 'True', 'blank': 'True'}),
            'file_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'scene_file': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'explorer.item': {
            ...
            'definition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.GhDefinition']"}),
            'has_3dm': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'rendering_view': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
