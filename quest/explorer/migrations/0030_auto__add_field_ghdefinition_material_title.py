...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GhDefinition.material_title'
        db.add_column('explorer_ghdefinition', 'material_title', self.gf('django.db.models.fields.CharField')(default='Material', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GhDefinition.material_title'
        db.delete_column('explorer_ghdefinition', 'material_title')
