...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionParam.parent'
        db.add_column('explorer_definitionparam', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorer.DefinitionParam'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DefinitionParam.parent'
        db.delete_column('explorer_definitionparam', 'parent_id')
    ...
    models = {
        ...
        'explorer.definitionparam': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.DefinitionParam']", 'null': 'True'}),
        ...
        'explorer.ghdefinition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_title': ('django.db.models.fields.CharField', [], {'default': "'Material'", 'max_length': '20'}),
        ...
        'explorer.item': {
            ...
            'definition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.GhDefinition']"}),
            'has_3dm': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
