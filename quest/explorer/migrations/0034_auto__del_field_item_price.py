...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('explorer_item', 'price')


    def backwards(self, orm):
        
        # Adding field 'Item.price'
        db.add_column('explorer_item', 'price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2), keep_default=False)
