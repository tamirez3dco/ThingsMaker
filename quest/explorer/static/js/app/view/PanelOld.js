Ext.define('Quest.view.Panel', {
	...
	qCreateCanvas : function() {
		var p = Ext.create('Ext.panel.Panel', {
			...
			hidden : true,
			html : '<canvas id="hover-canvas" style="opacity: 1; position: absolute; left: 0px; top: 0px" width=180px height=180px></canvas>' + '<div style="height: 30px; position: absolute; left: 0px; top: 154px" id="image-buttons">' + '<button id="makeit-button" style="position: absolute; width: 76px; left: -11px; top: -3px;" >Make It!</button></div>',
			listeners : {
				'afterrender' : {
					fn : function(panel) {
