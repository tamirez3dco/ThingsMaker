...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_category', (
            ...
            ('image', self.gf('lfs.core.fields.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
            ...
            ('uid', self.gf('django.db.models.fields.CharField')(default='d4c1d545-c22f-401f-be03-bad3ce49bd7e', unique=True, max_length=50)),
        ))
        ...
        db.create_table('catalog_product', (
            ...
            ('uid', self.gf('django.db.models.fields.CharField')(default='27c218dd-e737-46ae-a6d2-9d271705b1da', unique=True, max_length=50)),
        ))
        ...
        db.create_table('catalog_property', (
            ...
            ('uid', self.gf('django.db.models.fields.CharField')(default='398b5877-3f93-4f48-9706-5788a43096c9', unique=True, max_length=50)),
        ))
        ...
        db.create_table('catalog_propertyoption', (
            ...
            ('uid', self.gf('django.db.models.fields.CharField')(default='aa6ea3be-8f61-4eb1-80a3-12d290e92a0a', unique=True, max_length=50)),
        ))
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c1711c5b-0a1f-4054-9ad6-2116d056e016'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c3dfc89d-4ef6-4628-8649-2019f5a3532f'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'e6bf3347-da11-45f3-93e9-82bc18ee1856'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3fec2adb-c60b-41a3-88ae-7359e6861a02'", 'unique': 'True', 'max_length': '50'})
        },
        'catalog.staticblock': {
