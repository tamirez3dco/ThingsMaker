...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_designer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('bio', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('catalog', ['Designer'])


    def backwards(self, orm):
        
        # Deleting model 'Designer'
        db.delete_table('catalog_designer')
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c3155b53-35b5-411a-8021-910d19d66509'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'2a2df5a1-4762-465c-8383-920d61827c48'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'75d6e6e3-7717-4583-ad6e-6bd7f16dfbb0'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'63178cde-87bc-427e-bfc8-958ffca69bac'", 'unique': 'True', 'max_length': '50'})
        },
        'catalog.staticblock': {
