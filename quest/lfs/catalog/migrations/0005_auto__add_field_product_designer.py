...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_product', 'designer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Designer'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.designer'
        db.delete_column('catalog_product', 'designer_id')
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'4567c3c2-97ed-4bd7-b95e-139d6f4c220d'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'adfee4b9-40d3-454c-afc1-619d3c9e5067'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'82640ea5-817a-4735-9f52-5d0aa16cbc4e'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a74f87fd-f27a-4f92-b254-0f6610d298b1'", 'unique': 'True', 'max_length': '50'})
        },
        'catalog.staticblock': {
