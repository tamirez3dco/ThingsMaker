...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.ghdefinition'
        db.add_column('catalog_product', 'ghdefinition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorer.GhDefinition'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.ghdefinition'
        db.delete_column('catalog_product', 'ghdefinition_id')
    ...
    models = {
        ...
        'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'190e5b46-a9ee-4b13-b824-7744b3b2bbd9'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        'catalog.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Designer']", 'null': 'True', 'blank': 'True'}),
            ...
            'ghdefinition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.GhDefinition']", 'null': 'True', 'blank': 'True'}),
            'height': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['explorer.Item']", 'null': 'True', 'blank': 'True'}),
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'f2313f96-b82e-4ef8-9a5a-826978ce75ea'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5120b42b-ed45-43e3-a8ff-741192fc732a'", 'unique': 'True', 'max_length': '50'}),
        ...
        'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5c219da9-f4f4-422e-a431-20bc7075d57c'", 'unique': 'True', 'max_length': '50'})
        },
        'catalog.staticblock': {
        ...
        'explorer.ghdefinition': {
            ...
            'uploaded_file_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
